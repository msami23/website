                            ...
                            <td>
                                <div class="product_count">
                                    <input type="number" name="qty" id="sst" maxlength="12"
                                        value="{{$quantity[$product->id]}}" title="Quantity:" class="input-text qty">

                                </div>
                            </td>
                            <td>
                                <h5>${{$product->price * $quantity[$product->id]}}</h5>
                            </td>
                            <td><a href="{{route('cart.remove',[$product->id])}}" <button type="button"
                                    class="btn btn-outline-dark">Remove</button></a>
                            </td>
                        </tr>
                        @endforeach
