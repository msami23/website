  ...
  <section class="section-margin--small mb-5">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <section class="lattest-product-area pb-40 category-list">
            <div class="row">
                @foreach ($shop_category as $product )
	...
	<section class="related-product-area">
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-1.png')}}" alt=""></a>
              <div class="desc">
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-2.png')}}" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Gray Coffee Cup</a>
                <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-3.png')}}" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Gray Coffee Cup</a>
                <div class="price">$170.00</div>
              </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-4.png')}}" alt=""></a>
              <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-5.png')}}" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Gray Coffee Cup</a>
                <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-6.png')}}" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Gray Coffee Cup</a>
                <div class="price">$170.00</div>
              </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-7.png')}}" alt=""></a>
              <div class="desc">
                  <a href="#" class="title">Gray Coffee Cup</a>
                  <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-8.png')}}" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Gray Coffee Cup</a>
                <div class="price">$170.00</div>
              </div>
            ...
            <div class="single-search-product d-flex">
              <a href="#"><img src="{{asset('website/img/product/product-sm-9.png')}}" alt=""></a>
              <div class="desc">
                <a href="#" class="title">Gray Coffee Cup</a>
                <div class="price">$170.00</div>
              </div>
